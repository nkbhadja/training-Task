...
console.log(now1 - 1991 > now1 - 2018);
...
const jonas = "I'm " + firstName2 + ', a ' + (year2 - birthYear2) + ' year old ' + job3 + '!';
console.log(jonas);

const jonasNew = `I'm ${firstName2}, a ${year2 - birthYear2} year old ${job3}!`;
...
if (BMIMark3 > BMIJohn3) {
    console.log(`Mark's BMI (${BMIMark3}) is higher than John's (${BMIJohn3})!`)
} else {
    console.log(`John's BMI (${BMIJohn3}) is higher than Marks's (${BMIMark3})!`)
}
...
const age5 = 23;
// age5 >= 18 ? console.log('I like to drink wine 🍷') : console.log('I like to drink water 💧');
